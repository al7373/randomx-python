...
class TestCppVm(unittest.TestCase):
    ...
    def test_run(self):
        ...
        with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), '../_vm_interpreted/scratchpad_dump_0.bin'), 'rb') as f:
        ...
        with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), '../_vm_interpreted/scratchpad_dump_1.bin'), 'rb') as f:
